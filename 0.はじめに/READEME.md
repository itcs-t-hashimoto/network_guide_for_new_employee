...
HTTPのRFCを読むところまで行きましょう

## 第１回

ネットワークの概要を掴みましょう

講義の概要 ~ 講義動画 ~ WireSharkを使用してのハンズオン

## 第２回

ネットワークの詳細を押さえましょう

動画概要の説明 ~ 講義動画 * 2 ~ Advance 動画解説


## 第３回

第２回までに出てきた用語理解のために
WireSharkで実際に中身を見て復習しましょう

ハンズオン形式

##　第４回

開発に必要なセキュリティ知識を身につけましょう
一番使う知識として、HTTPプロトコルを押さえておきましょう
